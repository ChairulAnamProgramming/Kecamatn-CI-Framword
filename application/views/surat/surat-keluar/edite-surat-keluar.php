                ...
                <div class="col-lg-8">
                    <form action="" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="id" name="id" value="<?= $surat['id'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="dari" name="dari" value="<?= $surat['dari'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk" value="<?= $surat['tgl_masuk'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="perihal" name="perihal" value="<?= $surat['perihal'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="scan" name="scan" value="<?= $surat['scan'] ?>">
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary">Edite</button></div>
                        </div>
                    </form>
                </div>
            </div>
