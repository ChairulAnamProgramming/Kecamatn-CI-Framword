        ...
        <div class="container-fluid">
            ...
            <?= $this->session->userdata('message')?>
                    <form action="<?= base_url('persuratan/izinnikah')?>" method="post">
                        <div class="form-group row">
                            <label for="nik_suami" class="col-sm-2 col-form-label">Nik Suami</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik_suami" name="nik_suami" onkeyup="data_suami()" value="<?= set_value('nik_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik_istri" name="nik_istri" onkeyup="data_istri()" value="<?= set_value('nik_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik_ayah" name="nik_ayah" onkeyup="data_ayah()" value="<?= set_value('nik_ayah'); ?>" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik_ibu" name="nik_ibu" onkeyup="data_ibu()" value="<?= set_value('nik_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="checkbox" class="custom-control-input" id="jejaka" name="stts_pria" value="Jejaka">
                            <label class="custom-control-label" for="jejaka">Jejaka</label>
                            </div>

                            <div class="custom-control custom-checkbox mr-2">
                            <input type="checkbox" class="custom-control-input" id="duda" name="stts_pria" value="Duda">
                            <label class="custom-control-label" for="duda">Duda</label>
                            </div>

                            <div class="custom-control custom-checkbox mr-2">
                            <input type="checkbox" class="custom-control-input" id="beristri" name="stts_pria" value="Beristri">
                            ...
                            <input type="checkbox" class="custom-control-input" id="perawan" name="stts_wanita" value="Perawan">
                            <label class="custom-control-label" for="perawan">Perawan</label> 
                            </div>

                            <div class="custom-control custom-checkbox mr-2">
                            <input type="checkbox" class="custom-control-input" id="janda" name="stts_wanita" value="Janda">
                        ...
                        <div class="col-sm-2"></div>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_istri_suami" placeholder="Nama istri/ Suami terdahulu" name="nama_istri_suami" value="<?= set_value('nama_istri_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_suami" name="nama_suami" value="<?= set_value('nama_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="jk_suami" name="jk_suami" value="<?= set_value('jk_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tmpt_lhr_suami" name="tmpt_lhr_suami" value="<?= set_value('tmpt_lhr_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tgl_lhr_suami" name="tgl_lhr_suami" value="<?= set_value('tgl_lhr_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="agama_suami" name="agama_suami" value="<?= set_value('agama_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="pekerjaan_suami" name="pekerjaan_suami" value="<?= set_value('pekerjaan_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="alamat_suami" name="alamat_suami" value="<?= set_value('alamat_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="desa_suami" name="desa_suami" value="Tambak Bitin">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kecamatan_suami" name="kecamatan_suami" value="<?= set_value('kecamatan_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kabupaten_suami" name="kabupaten_suami" value="<?= set_value('kabupaten_suami'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_istri" name="nama_istri" value="<?= set_value('nama_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_ayah_istri" name="nama_ayah_istri" value="<?= set_value('nama_ayah_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="jk_istri" name="jk_istri" value="<?= set_value('jk_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tmpt_lhr_istri" name="tmpt_lhr_istri" value="<?= set_value('tmpt_lhr_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tgl_lhr_istri" name="tgl_lhr_istri" value="<?= set_value('tgl_lhr_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="agama_istri" name="agama_istri" value="<?= set_value('agama_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="pekerjaan_istri" name="pekerjaan_istri" value="<?= set_value('pekerjaan_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="alamat_istri" name="alamat_istri" value="<?= set_value('alamat_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="desa_istri" name="desa_istri" value="<?= set_value('desa_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kecamatan_istri" name="kecamatan_istri" value="<?= set_value('kecamatan_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kabupaten_istri" name="kabupaten_istri" value="<?= set_value('kabupaten_istri'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="jk_ayah" name="jk_ayah" value="<?= set_value('jk_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tmpt_lhr_ayah" name="tmpt_lhr_ayah" value="<?= set_value('tmpt_lhr_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tgl_lhr_ayah" name="tgl_lhr_ayah" value="<?= set_value('tgl_lhr_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="agama_ayah" name="agama_ayah" value="<?= set_value('agama_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="desa_ayah" name="desa_ayah" value="<?= set_value('desa_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kecamatan_ayah" name="kecamatan_ayah" value="<?= set_value('kecamatan_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kabupaten_ayah" name="kabupaten_ayah" value="<?= set_value('kabupaten_ayah'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="jk_ibu" name="jk_ibu" value="<?= set_value('jk_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tmpt_lhr_ibu" name="tmpt_lhr_ibu" value="<?= set_value('tmpt_lhr_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="tgl_lhr_ibu" name="tgl_lhr_ibu" value="<?= set_value('tgl_lhr_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="agama_ibu" name="agama_ibu" value="<?= set_value('agama_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="desa_ibu" name="desa_ibu" value="<?= set_value('desa_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kecamatan_ibu" name="kecamatan_ibu" value="<?= set_value('kecamatan_ibu'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="kabupaten_ibu" name="kabupaten_ibu" value="<?= set_value('kabupaten_ibu'); ?>">
