            ...
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="nik_ibu" name="nik_ibu" onkeyup="ibu()" value="<?= $skk['nik_ibu'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" value="<?= $skk['nama_ibu'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tmpt_ibu" name="tmpt_ibu" value="<?= $skk['tmpt_ibu'] ?>">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tgl_ibu" name="tgl_ibu" value="<?= $skk['tgl_ibu'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu" value="<?= $skk['pekerjaan_ibu'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamat_ibu" name="alamat_ibu" value="<?= $skk['alamat_ibu'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nik_ayah" name="nik_ayah" onkeyup="ayah()" value="<?= $skk['nik_ayah'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" value="<?= $skk['nama_ayah'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tmpt_ayah" name="tmpt_ayah" value="<?= $skk['tmpt_ayah'] ?>">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tgl_ayah" name="tgl_ayah" value="<?= $skk['tgl_ayah'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah" value="<?= $skk['pekerjaan_ayah'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamat_ayah" name="alamat_ayah" value="<?= $skk['alamat_ayah'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nik_anak" name="nik_anak" onkeyup="anak()" value="<?= $skk['nik_anak'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_anak" name="nama_anak" value="<?= $skk['nama_anak'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="jk_anak" name="jk_anak" value="<?= $skk['jk_anak'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tmpt_anak" name="tmpt_anak" value="<?= $skk['tmpt_anak'] ?>">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="tgl_anak" name="tgl_anak" value="<?= $skk['tgl_anak'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="hari" name="hari" value="<?= $skk['hari'] ?>">
                        <?= form_error('hari', '<small class="text-danger pl-3">', '</small>');  ?>
                    </div>

                    <label for="jam" class="col-sm-2 col-form-label">Jam</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="jam" name="jam" value="<?= $skk['jam'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="berat" name="berat" value="<?= $skk['berat'] ?>">
                        <?= form_error('berat', '<small class="text-danger pl-3">', '</small>');  ?>
                    </div>

                    <label for="panjang" class="col-sm-2 col-form-label">Panjang</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" id="panjang" name="panjang" value="<?= $skk['panjang'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="anak_ke" name="anak_ke" value="<?= $skk['anak_ke'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamat_anak" name="alamat_anak" value="<?= $skk['alamat_anak'] ?>">
